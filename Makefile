...
SCC=gcc -fpie -fPIC -Wall -Wextra
CC=clang -fpie -fPIC -O3 -Os -march=native -mtune=native -std=gnu99 -pedantic -Wall -Wextra -Wno-language-extension-token -fwrapv -DTIMECOP -DGETRANDOM
